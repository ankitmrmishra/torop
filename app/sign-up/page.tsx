      ...
      <div className="flex w-full items-center justify-center p-8 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleEmailSignUp} className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 h-4 w-4 rounded border-white/6 bg-[#0B0B0F] text-[#6366F1] focus:ring-[#6366F1]"
              />
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-sm text-[#A1A1AA]">Or register with</span>
            <div className="h-px flex-1 bg-white/6" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button
              ...
              disabled={isLoading}
              className="h-12 border border-white/6 border-white/50 bg-transparent text-[#F5F5F5] hover:bg-white hover:text-black"
            >
              <svg
