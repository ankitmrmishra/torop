          ...
          <div className="flex items-center gap-1">
            <Link href="/sign-in">
              <Button
                variant="ghost"
                size="sm"
                className="h-8 rounded-full px-3 text-xs text-[#A1A1AA] hover:bg-white/5 hover:text-[#F5F5F5] lg:px-4"
              >
                Sign In
              </Button>
            </Link>
                  ...
                  <div className="flex gap-2">
                    <Link href="/sign-in" className="flex-1">
                      <Button
                        variant="outline"
                        size="lg"
                        className="h-12 w-full rounded-lg border-white/10 font-medium text-[#F5F5F5] transition-all hover:bg-white/5"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        Sign In
                      </Button>
